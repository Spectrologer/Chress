 ...
 * @param assets - Array of asset paths
 * @returns Categorized assets
 */
function categorizeAssets(assets: string[]): AssetCategories {
 ...
 */
export function assetDiscoveryPlugin(): Plugin {
  let assetsDir = '';
  let scannedAssets: string[] = [];
  let categorizedAssets: AssetCategories = {
    walls: [],
    floors: [],
    flora: [],
    doodads: [],
