...
export function createMockGame(overrides: Record<string, any> = {}) {
    ...
    return {
        ...
        playerFacade: overrides.playerFacade || {
            ...
            hasVisitedZone: mockPlayer.hasVisitedZone || vi.fn().mockReturnValue(false),
            getThirst: mockPlayer.getThirst || vi.fn().mockReturnValue(50),
            getHunger: mockPlayer.getHunger || vi.fn().mockReturnValue(50),
            getHealth: mockPlayer.getHealth || vi.fn().mockReturnValue(100),
            hasAbility: vi.fn((ability: string) => mockPlayer.abilities.has(ability)),
            setAction: mockPlayer.setAction || vi.fn(),
            startBump: mockPlayer.startBump || vi.fn(),
            takeDamage: mockPlayer.takeDamage || vi.fn(),
            startAttackAnimation: mockPlayer.startAttackAnimation || vi.fn(),
            addPoints: mockPlayer.addPoints || vi.fn(),
        },
        grid: mockGrid,
        enemies: [],
        npcs: [],
