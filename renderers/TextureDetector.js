export class TextureDetector {
    ...
    static shouldUseDirtTunnelHorizontal(x, y, gridManager) {
    ...
    static shouldUseDirtTunnelVertical(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
    ...
    static shouldUseDirtNorth(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
    ...
    static shouldUseDirtSouth(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
    ...
    static shouldUseDirtEast(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
    ...
    static shouldUseDirtWest(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
    ...
    static countPassableDirections(x, y, gridManager, directions) {
        const GRID_SIZE = gridManager.getSize();
        let passableCount = 0;
    ...
    static checkPassableDirections(x, y, gridManager, directions) {
        const GRID_SIZE = gridManager.getSize();
    ...
    static shouldUseDirtCornerNE(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
    ...
    static shouldUseDirtCornerSE(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
    ...
    static shouldUseDirtCornerSW(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
    ...
    static shouldUseDirtCornerNW(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
    ...
    static shouldUseDirtCorner2NorthSouth(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
    ...
    static shouldUseDirtCorner2EastWest(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
        if (y === 0 || y === GRID_SIZE - 1 || x === 0 || x === GRID_SIZE - 1) return false;
    ...
    static shouldUseDirtCorner2SouthNorth(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
        if (y === 0 || y === GRID_SIZE - 1 || x === 0 || x === GRID_SIZE - 1) return false;
    ...
    static shouldUseDirtCorner2WestEast(x, y, gridManager) {
        const GRID_SIZE = gridManager.getSize();
